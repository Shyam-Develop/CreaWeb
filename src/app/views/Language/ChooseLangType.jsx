    ...
    >
      ...
      <Box sx={{ textAlign: "center", maxWidth: 300 }}>
        ...
        <Typography variant="body2" sx={{ opacity: 0.7, mb: 3 }}>
          Let us know what brings you to CREA so we can tailor your experience.
        </Typography>
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2,  }}>
          {[
            {
              label: "Hire Talent",
              desc: "Find verified creators and crew for your next project.",
            },
            {
              label: "Get Hired",
              desc: "Showcase your skills and land your next gig.",
            },
          ].map((item) => (
            <Card
              key={item.label}
