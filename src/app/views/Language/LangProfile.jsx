    ...
    <Box sx={{ maxWidth: 800, mx: "auto", p: 2 }}>
      ...
      <Box sx={{ maxWidth: 800, width: "100%", p: 2, textAlign: "center" }}>
        ...
        <Typography variant="body2" sx={{ mb: 3, color: "text.secondary" }}>
          We’ll use these details to verify your posting and keep you updated.
        </Typography>
      </Box>
...
/>
      ...
      {/* Budget */}
      <Typography fontWeight={500}>Budget range</Typography>
      ...
      <Typography >Choose a band; exact figures stay private</Typography>
