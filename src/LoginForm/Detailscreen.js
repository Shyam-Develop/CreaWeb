  ...
  return (
    <div style={styles.container}>
      <form onSubmit={handleContinue} style={styles.form}>
        {/* <img src="/google.png" alt="cover" style={styles.coverImage} /> */}

        {/* <div style={styles.profileSection}>
          <img src="/google.png" alt="profile" style={styles.profileImage} />
        </div> */}
        ...
        <div style={styles.checkboxContainer}>
          ...
          <label style={styles.checkboxLabel}>I am currently working in this role</label>
        </div>
